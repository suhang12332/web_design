...
public class MailUtils {
    public static Boolean mailUtils(String Addressee_mail,String username) {
        boolean falg = false;
        ...
        try {
            ...
            String body="<body bgcolor=\"#222222\">\n" +
                    ...
                    "                                            <div class=\"body-title\">嗨, "+username+",当你收到这封邮件的时候，恭喜你，已经成为了本论坛的会员，希望在今后的时间里，你会在本论坛收获良多。</div>\n" +
