            ...
            <div class="row">
                <div class="col-md-offset-3 col-md-6" style="margin-top:20px;">
                    ...
                    <form class="form-horizontal" style="opacity: 0.99;z-index: 1; padding:10px 10px">
                        <span class="heading" style="color:#555; font-size:30px;">找 回 密 码</span>
                        ...
                        <div class="form-group help">
                            <input type="qq" class="form-control" placeholder="Q Q" name="qq" required>
                            <i class="fas fa-lock" style="text-shadow: 0 1px 3px rgba(0,0,0,.0); font-size: 15px"></i>
                        </div>
                        <div class="form-group help">
                            <input type="email" class="form-control" placeholder="邮 箱" name="email" required>
                            <i class="fas fa-lock" style="text-shadow: 0 1px 3px rgba(0,0,0,.0); font-size: 15px"></i>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-default btn-block" style="outline: none;"
                                    name="username" formmethod="post" formaction="FindPasswordServlet">确认
                            </button>
                        </div>
                    </form>
                </div>
